...
//#define RGB_MATRIX_DEFAULT_MODE ENABLE_RGB_MATRIX_CYCLE_ALL // Sets the default mode, if none has been set
#define RGB_MATRIX_DEFAULT_HUE 0 // Sets the default hue value, if none has been set
#define RGB_MATRIX_DEFAULT_SAT 255 // Sets the default saturation value, if none has been set
#define RGB_MATRIX_DEFAULT_VAL 0 // Sets the default brightness value, if none has been set
#define RGB_MATRIX_DEFAULT_SPD 66 // Sets the default animation speed, if none has been set
